const data = [
  ...
  // },
  {
    ...
    description:
      'A Node.js chatting application enables real-time communication between users.',
    image: {
    ...
    links: {
      site: 'https://chatapp-zwtv.onrender.com',
      repo: 'https://github.com/rsap4you/chatapp',
    },
    technologies: [
      '#Nodejs' ,
      '#Javascript',
  ...
  },
  {
    ...
    title: 'TextUtils',
    description:
      'Textutils software is able to read aloud any text you type, you can also upload a TXT file to be read. Its main feature is that it can record your text into an audio file in Wav format. It incorporates a conversion tool so you can compress wav files generated in mp3 format ',
    image: {
      src: 'https://res.cloudinary.com/dx6tl6aa2/image/upload/v1671564532/portfolio/projects/Syntho/Screenshot_2022-12-20_at_21.26.17_1_c59hzo.jpg',
      placeholderSrc:
        'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAzIDIiPjwvc3ZnPg==',
    ...
    links: {
      site: 'https://rsap4you.netlify.app/',
      repo: 'https://github.com/rsap4you/textutil',
    },
    technologies: [
      '#ReactJs',
     '#NodeJs',
